sap.ui.define([
	...
	"sap/ui/Device",
	"com/sap/bpm/ReworkCapex/model/models",
    "sap/ui/model/json/JSONModel"
], function (UIComponent, Device, models, JSONModel) {
	"use strict";

	return UIComponent.extend("com.sap.bpm.ReworkCapex.Component", {
        ...
        init: function () {
            ...
            var contextModel = new JSONModel("/comsapbpmReworkCapex/workflowruntime/v1/task-instances/" + taskId + "/context");
            ...
            var taskInstanceModel = new JSONModel("/comsapbpmReworkCapex/workflowruntime/v1/task-instances/" + taskId);
