sap.ui.define([
    ...
    "use strict";
    return Controller.extend("com.sap.bpm.StartCapex.BaseController", {
        ...
        fnInitializeApp: function () {
            ...
            var sRootPath = jQuery.sap.getModulePath("com.sap.bpm.StartCapex");
            oMdlCommon.attachRequestCompleted(function (oEvent) {

                var requestId = Math.floor(Date.now() / 1000);
                oMdlCommon.setProperty("/oInvestmentDetails/sRequestId", requestId);
                oMdlCommon.refresh();
            });
